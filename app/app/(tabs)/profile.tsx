...
import { Bookmark, Grid3x3, LogOut, MapPin } from "lucide-react-native";
...
export default function ProfileScreen() {
    ...
    const avatarUrl = data?.profile.avatar_url ? buildImageUrl(data.profile.avatar_url, { width: 200, quality: 90 }) : undefined;
        ...
        <View className="flex-1 bg-kara-bg">
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 100 }}>
                ...
                <View style={{ position: "relative", height: 230 }}>
                    <KaraPhoto tone="cyan-tokyo" src={coverUrl} style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0 }} />
                    <LinearGradient
                ...
                <View style={{ marginTop: -56, paddingHorizontal: 20, position: "relative", zIndex: 3 }}>
                    ...
                    {bio && (
                        <Text style={{ marginTop: 12, color: "#F1F0FF", fontSize: 14, lineHeight: 22, fontFamily: "Inter_400Regular" }}>{bio}</Text>
                    )}
                    ...
                    {(
                        ...
                        <Pressable
                            ...
                            style={{
                                ...
                                borderWidth: 1,
                                borderColor: tab === t.id ? "#2A2A3D" : "transparent",
                                flexDirection: "row",
                                alignItems: "center",
                                justifyContent: "center",
                                gap: 6,
